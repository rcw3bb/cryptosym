...
public class CryptoSymTest {
    ...
    public void encWithNullKeyParameter() {
        final var text = "TEST_ONLY";
        assertThrows(RuntimeException.class, ()-> CryptoSym.encrypt((String) null, text));
    }

    @Test
    public void decWithNullKeyParameter() {
        final var text = "TEST_ONLY";
        assertThrows(RuntimeException.class, ()-> CryptoSym.decrypt((String) null, text));
    }

    @Test
    public void encWithNullTextParameter() {
        final var key = "TEST_ONLY";
